...
Flags.DEFINE_float('combined_mse_scaling', 0.01, 'The scaling factor for MSE loss if using combined perceptual loss')
Flags.DEFINE_float('combined_vgg22_scaling', 0.0001, 'The scaling factor for VGG22 loss if using combined perceptual loss')
...
# The training mode
    ...
    # When using MSE loss, no need to restore the net
